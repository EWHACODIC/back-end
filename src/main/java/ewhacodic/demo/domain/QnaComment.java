...
public class QnaComment {
    ...
    @Builder
    public QnaComment(Long id, String content, Long userCode, Long postId, LocalDateTime createdAt, LocalDateTime modifiedAt){
        this.id = id;
    ...
    public static QnaComment of(BoardCommentDto boardCommentDto, Long postId) {
