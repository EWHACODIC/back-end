...
public class Tech {
    ...
    @Builder
    public Tech(Long id, String title, String content, String tag1, String tag2, Long view, Long recommend, Long userCode, LocalDateTime createdAt, LocalDateTime modifiedAt){
        this.id = id;
        this.title = title;
    ...
    public static Tech updateRecommend(Tech boardDto) {
